...
function run_database_setup() {
  ...
  mysql -u root --execute="CREATE DATABASE integradas;"
  mysql -u root --execute="CREATE USER 'integradas'@'localhost' IDENTIFIED WITH mysql_native_password BY '$DB_PASS';"
  mysql -u root --execute="GRANT ALL ON integradas.* TO 'integradas'@'localhost';FLUSH PRIVILEGES;"

  mysql -u root --execute="CREATE DATABASE phpmyadmin;"
  mysql -u root --execute="CREATE USER 'phpmyadmin'@'localhost' IDENTIFIED WITH mysql_native_password BY '$DB_PASS';"
  mysql -u root --execute="GRANT ALL ON phpmyadmin.* TO 'phpmyadmin'@'localhost';FLUSH PRIVILEGES;"

  mysql -u root --execute="CREATE DATABASE geral;"
  mysql -u root --execute="CREATE USER 'geral'@'localhost' IDENTIFIED WITH mysql_native_password BY '$DB_PASS';"
  mysql -u root --execute="GRANT ALL ON geral.* TO 'geral'@'localhost';FLUSH PRIVILEGES;"
}
